...
def main(runtime, version):
    ...
    click.echo("Deploying titiler-pgstac layer", err=True)
    for region in AWS_REGIONS:
        ...
        s3_bucket = f"titiler-pgstac-layers-{region}"
        s3_key = f"titiler-pgstac{version_nodot}-py{runtime_nodot}.zip"
